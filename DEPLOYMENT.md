...
המנהל שולח **קישור אחד** לקבוצת הצוות. כל מורה נכנס, בוחר את שמו (או מזין אם אין ברשימה), ממלא ושולח.

**איפה הכפתור?**
- **מסך הצוות שלי** – אייקון שרשרת (🔗) בפינה בראש המסך
- **הגדרות** – כרטיס "שאלון מעורבות" עם כפתור "העתק קישור ושתף"
